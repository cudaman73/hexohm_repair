(function() {
	//called when document completely loaded
	function onload(){
	wildMagic.onclick = function(){
		
	var button = document.getElementById('wildMagic');
	var wildMagicArray = ["1d10 of caster's fingers turn to stone",
...
"Before each spell, caster must say \"My God, its full of stars",
...
"Caster confesses to improbable crimes (eg \"I stole the moon'\")",
...
"The Stars Are Right!"];
	var lengthArray = ["10d100 hours have passed",
"1d4 turns have passed per level of the caster",
"He has attained fluency in 1d4 additional languages",
...
"He has had a personal audience with 1d6 different deities",
...
"He has spent a night in a sty with at least 3d10 pigs",
"He has spent a night in each of 2d6 dragons' lairs",
...
"He unearths 1d4 pounds of gold",
"His next birthday",
...
"He has been bitten by 1d6 different lycanthropes"];
	...
	*/
	...
	button.onclick = function() {
		...
		//	post result to text box
		var effectKey = getRandomInt(0,9999);
		var lengthKey = getRandomInt(0,99);
		num += 1;
		effectText.value += num + " " + getEffect(effectKey, wildMagicArray) + " UNTIL " + getEffect(lengthKey, lengthArray) + "\n";
		//lengthText.value = getEffect(lengthKey, lengthArray);
		//alert (effectText.value + " until " + lengthText.value)
